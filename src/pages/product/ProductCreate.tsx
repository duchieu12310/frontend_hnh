    ...
    <div className="flex flex-col gap-4" style={{ maxWidth: 1200 }}>
      ...
      <Modal opened={opened} onClose={close} title="✨ Nhập dữ liệu thông minh từ văn bản thô" size="lg">
        <div className="flex flex-col gap-4">
          <p className="text-xs text-slate-500 italic">Dán đoạn văn bản chứa thông tin sản phẩm (từ web khác, tin nhắn...), AI sẽ tự động tách và điền vào các ô.</p>
          <Textarea 
        ...
        <div className="flex gap-5 items-start">
          ...
          <div className="flex flex-col gap-4" style={{ flex: '0 0 68%' }}>
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
              <div className="flex items-center justify-between mb-3">
                ...
                >
                  {showVariants ? '▲ Ẩn bớt' : '▼ Mở rộng phiên bản'}
                </button>
              </div>
              {showVariants && (
                <ProductVariants
              ...
              {!showVariants && (
                <p className="text-xs text-slate-400 italic">Nhấp "Mở rộng phiên bản" để thêm biến thể (màu sắc, kích cỡ...).</p>
              )}
            </div>
          ...
          <div className="flex flex-col gap-4" style={{ flex: '0 0 30%' }}>
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4 flex gap-2">
              ...
              <Button type="submit" fullWidth>Thêm sản phẩm</Button>
            </div>
