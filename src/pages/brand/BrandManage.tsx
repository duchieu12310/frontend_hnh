...
function BrandManage() {
  useResetManagePageState(BrandConfigs.resourceKey);
  ...
  const showedPropertiesFragment = (entity: BrandResponse) => (
    <>
      ...
      <td><StatusToggle status={entity.status} entityId={entity.id} resourceUrl={BrandConfigs.resourceUrl} resourceKey={BrandConfigs.resourceKey} /></td></>
  );
