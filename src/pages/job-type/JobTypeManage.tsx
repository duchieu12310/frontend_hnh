...
function JobTypeManage() {
  useResetManagePageState(JobTypeConfigs.resourceKey);
  ...
  const showedPropertiesFragment = (entity: JobTypeResponse) => (
    <>
      ...
      <td><StatusToggle status={entity.status} entityId={entity.id} resourceUrl={JobTypeConfigs.resourceUrl} resourceKey={JobTypeConfigs.resourceKey} /></td></>
  );
