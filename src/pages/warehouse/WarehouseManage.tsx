...
function WarehouseManage() {
  useResetManagePageState(WarehouseConfigs.resourceKey);
  ...
  const showedPropertiesFragment = (entity: WarehouseResponse) => (
    <>
      ...
      <td><StatusToggle status={entity.status} entityId={entity.id} resourceUrl={WarehouseConfigs.resourceUrl} resourceKey={WarehouseConfigs.resourceKey} /></td></>
  );
