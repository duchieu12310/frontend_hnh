...
export interface ClientProductResponse {
  ...
  productTags: ClientProductResponse_ClientTagResponse[];
}

interface ClientProductResponse_ClientSupplierResponse {
  supplierId: number;
  supplierName: string;
}

interface ClientProductResponse_ClientUnitResponse {
  unitId: number;
  unitName: string;
}

interface ClientProductResponse_ClientTagResponse {
  tagId: number;
  tagName: string;
}
...
interface ClientProductResponse_ClientVariantResponse {
  ...
  variantSku: string;
  variantProperties: CollectionWrapper<VariantPropertyItem> | null;
  variantImages: any; // or JsonNode equivalent
